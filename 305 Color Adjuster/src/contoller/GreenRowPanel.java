    ...
    private void addListeners() {
        ...
        myValueField.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(final FocusEvent theEvent) {
                ...
                Integer greenInput;
                try {
                    greenInput = Integer.parseInt(input); 
                } catch (final NumberFormatException error) {
                    greenInput = myColor.getBlue();
                }
                if (greenInput >= ColorModel.MIN_VALUE && greenInput <= ColorModel.MAX_VALUE) {
                    myColor.setGreen(greenInput);
                }
                final String oldValue = Integer.toString(myColor.getBlue());
